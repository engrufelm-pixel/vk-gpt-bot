...
WALLPAPER_PROMPT = (
    ...
    "but with the wallpaper from Image 2 applied to EVERY wall surface in the room.\n\n"
    "CRITICAL — cover ALL walls, leave NO wall with the old finish:\n"
    "- The main wall facing the camera AND all side walls (left wall, right wall, back wall)\n"
    "- Walls seen at a steep or oblique angle to the camera\n"
    "- Narrow wall strips, wall sections near corners, around windows, doors and furniture\n"
    "- Wall areas partially hidden behind furniture\n"
    "Every wall must show the new wallpaper with a CONSISTENT pattern and scale, "
    "and correct perspective/foreshortening on angled walls. "
    "Double-check each wall in the image: none of them may keep the original wallpaper or paint.\n\n"
